...
local t = Def.ActorFrame {
	InitCommand=function(self)
		...
		self:visible(not ThemePrefs.Get("RainbowMode") and style ~= "SRPG8" and style ~= "Technique" and style ~= "ITG")
	end,
	...
	VisualStyleSelectedMessageCommand=function(self)
		...
		if ThemePrefs.Get("RainbowMode") or style == "SRPG8" or style == "Technique" or style == "ITG" then
